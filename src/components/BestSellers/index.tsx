    ...
    <div className={styles.productsection}>
      ...
      <div className={styles.productcards}>
        <div className={styles.productcard}>
          <Image src="/asic/asic1.png" alt="Product 1" />
          <p className={styles.smalltext}>BITMAIN, ASIC-МАЙНЕРЫ, АСИКИ S19</p>
          <h3>Название товара 1</h3>
        </div>
        <div className={styles.productcard}>
          <Image src="/asic/asic2.png" alt="Product 2" />
          <p className={styles.smalltext}>BITMAIN, ASIC-МАЙНЕРЫ, АСИКИ S19</p>
          <h3>Название товара 2</h3>
        </div>
        <div className={styles.productcard}>
          <Image src="/asic/asic1.png" alt="Product 3" />
          <p className={styles.smalltext}>BITMAIN, ASIC-МАЙНЕРЫ, АСИКИ S19</p>
          <h3>Название товара 3</h3>
        </div>
        <div className={styles.productcard}>
          <Image src="/asic/asic2.png" alt="Product 4" />
          <p className={styles.smalltext}>BITMAIN, ASIC-МАЙНЕРЫ, АСИКИ S19</p>
          <h3>Название товара 4</h3>
        </div>
        <div className={styles.productcard}>
          <Image src="/asic/asic1.png" alt="Product 5" />
          <p className={styles.smalltext}>BITMAIN, ASIC-МАЙНЕРЫ, АСИКИ S19</p>
