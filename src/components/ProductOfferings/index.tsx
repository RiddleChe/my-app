        ...
        <section className={styles.offerings}>
          ...
          <div className={styles.offersGrid}>
            <div className={styles.offer}>
              <img src="/icons/rozetca.svg" alt="Продажа оборудования" className={styles.icon} />
            ...
            <div className={styles.offer}>
              <img src="/icons/like.svg" alt="Размещение на хостинге" className={styles.icon} />
              <div className={styles.text}>
            ...
            <div className={styles.offer}>
              <img src="/icons/zepi.svg" alt="Подключение к пулу" className={styles.icon} />
              <div className={styles.text}>
